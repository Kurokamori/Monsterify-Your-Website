...
pool.query(`
  ...
  ('berry_shop', 'Berry Shop', 'A shop that sells various berries.', 'berries', 'https://i.imgur.com/5cgcSGC.png', 2, 5, 0.7, 1.3),
  ('ball_shop', 'Ball Shop', 'A shop that sells various Poké Balls.', 'balls', 'https://i.imgur.com/cYMAGK8.jpeg', 1, 3, 1.0, 1.5),
  ('evolution_shop', 'Evolution Shop', 'A shop that sells evolution items.', 'evolution', 'https://i.imgur.com/bakery.png', 1, 3, 1.2, 1.8),
  ('antique_shop', 'Antique Shop', 'A shop that sells rare and unique items.', 'antiques', 'https://i.imgur.com/antique.png', 1, 2, 1.5, 2.0),
  ('pastry_shop', 'Pastry Shop', 'A shop that sells delicious pastries for your monsters.', 'pastries', 'https://i.imgur.com/pastry.png', 2, 4, 0.8, 1.2),
  ('item_shop', 'Item Shop', 'A shop that sells various useful items.', 'items', 'https://i.imgur.com/items.png', 3, 6, 0.9, 1.3),
  ('egg_shop', 'Egg Shop', 'A shop that sells egg-related items.', 'eggs', 'https://i.imgur.com/eggs.png', 1, 3, 1.1, 1.6),
  ('black_market_shop', 'Black Market', 'A shop that sells rare and exotic items.', 'black_market', 'https://i.imgur.com/black_market.png', 1, 3, 1.5, 2.5)
