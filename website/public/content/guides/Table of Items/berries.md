# Berries
Berries allow you to remove or randomize different traits of your monster, and can be used in the Apothecary.
...
| Siron Berry      | Remove Type 1 and shift remaining types (only if monster has more than one type) |
