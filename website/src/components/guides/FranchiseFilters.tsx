import { FRANCHISE_CONFIG, FranchiseKey } from '../../services/speciesService';
...
export const FranchiseFilters = ({ franchise, filters, onFilterChange }: FranchiseFiltersProps) => {
  ...
  const renderTypeFilter = (filterKey: string, label: string) => {
  ...
  const renderRankFilter = (filterKey: string, label: string) => {
    let ranks: string[];
  ...
  const renderStageFilter = (filterKey: string, label: string) => {
    const currentValue = filters[filterKey] || '';
  ...
  const renderTribeFilter = (filterKey: string, label: string) => {
    const currentValue = filters[filterKey] || '';
  ...
  const renderAttributeFilter = (filterKey: string, label: string) => {
    const currentValue = filters[filterKey] || '';
  ...
  const renderElementFilter = (filterKey: string, label: string) => {
  ...
  const renderBooleanFilter = (filterKey: string, label: string) => {
    const currentValue = filters[filterKey] || '';
  ...
  const renderCategoryFilter = (filterKey: string, label: string) => {
  ...
  const renderFilter = (filterKey: string, filterConfig: { label: string; type?: string }) => {
